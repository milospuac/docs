...
Firstly, go to Settings and from there click on `Billing`. You will see the `Go to the billing portal` button. Click on that and it will take you to the page where it shows your Current Plan as well as an option to upgrade/downgrade your plan.
